                ...
                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                  <div className="flex-1">
                    ...
                    <a href={data.href} className="mt-2 block">
                      <p id={index} className="lg:text-4xl pt-4 pb-6 text-2xl font-semibold text-gray-900 transition duration-400 ease-in-out">{data.title}</p>
                      <p className="mt-3 text-2xl space-y2 leading-9 text-gray-500">{data.description}</p>
                    </a>
                  </div>
                </div>
              </Link>
